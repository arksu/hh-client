...
public class IMeter extends Widget {
	...
	if(msg == "set") {
        ...
        if (bgname.equals("gfx/hud/meter/nrj"))
            ark_bot.Stamina = meters.get(0).a;
        ...
        if (bgname.equals("gfx/hud/meter/hp")) {
            ...
            temp = s.split("/");
            if (temp != null) {
                ark_bot.HP = Integer.parseInt(temp[0]);
                ark_log.LogPrint("set HP="+ark_bot.HP);
            }
        }
        if (bgname.equals("gfx/hud/meter/hngr")) {
            ...
            if (r.length() > 0) {
                ark_bot.Hungry = Integer.parseInt(r);
                ark_log.LogPrint("set hungry="+ark_bot.Hungry);
            }
        }
	} else {
