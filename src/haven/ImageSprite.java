...
public abstract class ImageSprite extends Sprite {
	...
	public void draw(GOut g) {
        if (    ark_bot.mapview.gob_at_mouse != null &&
                owner != null &&
                (((Config.highlight_object_by_mouse) || (ark_bot.mapview.mode_select_object)) && ((Gob)owner).id == ark_bot.mapview.gob_at_mouse.id) 
                && !Config.xray) {
    ...
    public void drawol(GOut g, java.awt.Color col) {
        if(ol == null)
